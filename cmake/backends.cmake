...
if(NOT ditched_${name}_${ver})
  ExternalProject_Add(${name}_${ver}
    ...
    CONFIGURE_COMMAND CC=${CMAKE_C_COMPILER} FC=${CMAKE_Fortran_COMPILER} CFLAGS=${MACOSX_SYSROOT_FLAGS} LDFLAGS=${MACOSX_LINKER_FLAGS} ${PYTHON_EXECUTABLE} ${dir}/waf configure --cfitsio_include=${cfitsio_dir}/include --cfitsio_lib=${cfitsio_dir}/lib ${mkl_libs_option} --no_pytools
    BUILD_COMMAND ""
