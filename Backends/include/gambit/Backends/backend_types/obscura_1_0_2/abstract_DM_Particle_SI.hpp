#ifndef __abstract_DM_Particle_SI_obscura_1_0_2_hpp__
#define __abstract_DM_Particle_SI_obscura_1_0_2_hpp__
    ...
    namespace obscura
    {
        class Abstract_DM_Particle_SI : virtual public obscura::Abstract_DM_Particle_Standard
        {
            public:
                ...
                virtual void Set_FormFactor_DM(::std::basic_string<char>, double) =0;
    
                virtual void Set_FormFactor_DM__BOSS(::std::basic_string<char>) =0;
...
#endif /* __abstract_DM_Particle_SI_obscura_1_0_2_hpp__ */
