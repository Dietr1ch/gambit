...
#define gm2calc_1_3_0_all_data \
  ...
  (( /*class*/(gm2calc)(ESetupError),    /*constructors*/((("Factory_ESetupError_0__BOSS_15","_Factory_ESetupError_0__BOSS_15"),(const std::basic_string<char>&))) )) \
  (( /*class*/(gm2calc)(EInvalidInput),    /*constructors*/((("Factory_EInvalidInput_0__BOSS_16","_Factory_EInvalidInput_0__BOSS_16"),(const std::basic_string<char>&))) )) \
  (( /*class*/(gm2calc)(EPhysicalProblem),    /*constructors*/((("Factory_EPhysicalProblem_0__BOSS_17","_Factory_EPhysicalProblem_0__BOSS_17"),(const std::basic_string<char>&))) )) \
  (( /*class*/(gm2calc)(EReadError),    /*constructors*/((("Factory_EReadError_0__BOSS_18","_Factory_EReadError_0__BOSS_18"),(const std::basic_string<char>&))) )) \
